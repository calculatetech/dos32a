...
if (-not $logText.Contains('Version:        26.1.2')) {
    Write-Host 'SVER did not report DOS/32A version 26.1.2.'
    Show-SmokeLogTail -Path $log
    Exit-Smoke 1
}

Select-String -Path $log -Pattern 'SVER -- Version|Version:        26\.1\.2|SVER_SMOKE_OK|DIRECT_LOADER_SMOKE_OK|DOS32A_SMOKE_OK|Hello world from protected mode!!!|APP_SMOKE_OK' |
